<div id="header">
	<h1 class="title">Manual prático-teórico de Bioinformática Estrutural</h1>
	<h2 class="subtitle"><em>UFMG</em></h2>
	<p class="author"><em>Laboratório de Bioinformática e Sistemas</em></p>
